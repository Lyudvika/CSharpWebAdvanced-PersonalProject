        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Content = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false, comment: "Content of the post."),
                    ...
                    AuthorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Id of the user who wrote the post."),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "To check if post is deleted.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "To check if reply is deleted."),
                    AuthorId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "User Id of the person who gave the reply."),
                    PostId = table.Column<int>(type: "int", nullable: false, comment: "Post ID to which the reply is associated.")
                },
                constraints: table =>
                {
